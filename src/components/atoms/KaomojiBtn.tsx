...
const KaomojiBtn: React.FC<KaomojiBtnProps> = ({ text, onCopy, isCopied, className }) => {
  ...
  return (
    <button
      ...
      aria-live="polite"
      className={cn(
        'bg-white rounded-lg px-2 sm:px-3 py-2 shadow text-sm md:text-lg font-medium text-nowrap border-2 border-transparent hover:border-primary-500/25 hover:text-pink-500 focus:border-transparent transition-colors duration-300 user-select-none',
        {
